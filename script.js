...
function generateTrackingDetails(trackingNumber) {
  var trackingDetails = [
    { trackingNumber: 'LON321612789CZE', status: 'V průběhu přepravy', location: 'Lon, Seaport 3', date: '05-31th', time: '11:57' },
    { trackingNumber: 'LON201654709CZE', status: 'V průběhu přepravy', location: 'Lon, Seaport 2', date: '05-31th', time: '11:15' },
